        ...
        >
          ...
          {currencies.map((currency) => (
            ...
            >
              ...
              <div className={selectedCurrency.code === currency.code ? `${styles.item__mark}` : `${styles['item__mark--none']}`}>✓</div>
            </div>
          ))}
        </div>
      )}
...
//   `${styles.item__mark} ${styles.item__active}` :
//   `${styles['item__mark-none']}`}>✓</div>