    ...
    <nav className={styles.nav}>
      ...
      {!isEnterLogIn ?
        <button onClick={toggleRegister} className={`${styles.link} btn-reset`}>
          <span className={`${styles.link__icon} ${styles['link__icon--log-in']}`}>Войти</span>
        </button>
        :
        <Link href="/" onClick={toggleRegister} className={`${styles.link} btn-reset`}>
          <span className={`${styles.link__icon} ${styles['link__icon--log-in']}`}>Профиль</span>
        </Link>
      }
      <button onClick={toggleRegister} className={`${styles.link} btn-reset`}>
