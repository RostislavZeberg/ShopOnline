...
export const AuthForm = () => {
  ...
  return (
    <div className={styles.autorisieren}>
      ...
      {/* <div className={styles.autorisieren__info}>
      ...
      <div
        className={
          isAutorisieren ? `${styles['autorisieren__vestibule']} ${styles['vestibule']}` : `${styles['vestibule-none']}`
        }
      >
        <h4 className={styles['vestibule__title']}>Регистрация завершена</h4>
        <p className={styles['vestibule__descr']}>
          Используйте вашу электронную почту для входа
        </p>
        <Button
          className={`${styles['autorisieren__button']} btn-reset`}
