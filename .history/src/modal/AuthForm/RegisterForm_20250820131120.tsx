...
export const RegisterForm: FC<RegisterFormProps> = ({ setAuthType }) => {
  ...
  // console.log("formData:", formData.email === userData?.email)
  ...
  return (
    <form className={`${styles.registerForm} autorisation__block autorisation__registration registration`} onSubmit={handleSubmit}>
