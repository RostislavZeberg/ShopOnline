...
export const LoginForm: FC<RegisterFormProps> = ({ setAuthType }) => {
  ...
  // console.log("localstorage:", window.localStorage.getItem('userData'))

  return (
    <form className={`${styles.loginForm} autorisieren__block autorisieren__registration registration`} onSubmit={handleSubmit}>
