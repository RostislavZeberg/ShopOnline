...
export const SearchProductDetailed = () => {
  ...
  return (
    ...
    >
      ...
      <label htmlFor="search-field-color" className={styles['search-detailed__label']}>
      ...
      <div className={styles.priceRange}>
        <label htmlFor="price-min" className={styles['search-detailed__label']}>
          <span className={styles['search-detailed__title--label']}>Минимальная цена:</span>
          <input
            id="price-min"
            name="minPrice"
            type="number"
        ...
        <label htmlFor="price-max" className={styles['search-detailed__label']}>
          <span className={styles['search-detailed__title--label']}>Максимальная цена:</span>
          <input
            id="price-max"
            name="maxPrice"
            type="number"
